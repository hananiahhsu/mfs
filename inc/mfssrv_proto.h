...
typedef enum
{
	...
	MFSSUP_TYPE_ESERVICE,			/* No mfs service processes */
	MFSSUP_TYPE_SNOTSUP,			/* Not supported type */
	MFSSUP_TYPE_SMFS,				/* Mfs extend support */
}mfssup_type_e;
...
#define MFSSRV_REMOTEFD_MAKERFD(pid)	((pid) | MFSSRV_REMOTEFD_MASK)
